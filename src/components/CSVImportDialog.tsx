        ...
        try {
          ...
          if (data.success) {
            ...
            toast({
              ...
              description: `Imported ${data.report.imported} trades from CSV`,
            });
          } else {
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Upload your Zerodha tradebook CSV file to import historical trades with P&L data.
            </DialogDescription>
          </DialogHeader>
